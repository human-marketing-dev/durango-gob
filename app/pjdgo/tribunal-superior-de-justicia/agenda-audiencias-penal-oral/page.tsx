...
export const metadata: Metadata = {
  title: 'Agenda de Audiencias Sistema de Justicia Penal Oral — Tribunal Superior de Justicia — PJDGO',
  description: 'Consulta la agenda de audiencias del sistema de justicia penal oral del Tribunal Superior de Justicia del Poder Judicial del Estado de Durango.',
}
  ...
  return (
    <div className="bg-white">
      ...
      <div style={{ borderBottom: '1px solid #B8C0B8' }}>
        <div className="max-w-content mx-auto site-px py-3 flex items-center gap-2 flex-wrap">
          ...
          <span className="font-lato text-primary" style={{ fontSize: '12px', letterSpacing: '0.3px' }}>
            Agenda de Audiencias Sistema de Justicia Penal Oral
          </span>
        </div>
      </div>
      ...
      <div className="max-w-content mx-auto site-px" style={{ paddingTop: '64px', paddingBottom: '48px', borderBottom: '1px solid #B8C0B8' }}>
        ...
        >
          Agenda de Audiencias<br />Sistema de Justicia Penal Oral
        </h1>
        <p className="font-lato text-accent" style={{ fontSize: '16px', lineHeight: '1.7em', letterSpacing: '0.3px', maxWidth: '680px' }}>
          Consulta el calendario de audiencias programadas en el sistema de justicia penal oral del Tribunal Superior de Justicia del Estado de Durango.
        </p>
      </div>
      ...
      <div className="max-w-content mx-auto site-px" style={{ paddingTop: '48px', paddingBottom: '80px' }}>
        <div style={{ width: '100%', overflow: 'hidden', border: '1px solid #B8C0B8' }}>
          <iframe
            src="https://calendar.google.com/calendar/embed?height=600&wkst=1&bgcolor=%23ffffff&ctz=America%2FMexico_City&src=YWRtb25janAxZHRvQGdtYWlsLmNvbQ&src=ZXMtNDE5Lm1leGljYW4jaG9saWRheUBncm91cC52LmNhbGVuZGFyLmdvb2dsZS5jb20&color=%23039BE5&color=%230B8043"
            style={{ border: 0, display: 'block', width: '100%', minHeight: '600px' }}
            width="100%"
            height="600"
            frameBorder={0}
            scrolling="no"
            title="Agenda de Audiencias Sistema de Justicia Penal Oral"
          />
        </div>
      </div>
