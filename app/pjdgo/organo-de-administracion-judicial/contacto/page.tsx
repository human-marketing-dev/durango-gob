...
import { contactoOrganoAdministracion } from '@/lib/contactos'

export const metadata: Metadata = {
  title: 'Contacto — Órgano de Administración — Poder Judicial del Estado de Durango',
  description: 'Directorio de contacto del Órgano de Administración del Estado de Durango: comisionados, secretariado ejecutivo, órganos auxiliares y centros adscritos.',
}
    ...
    <div className="bg-white">
      ...
      <div className="max-w-content mx-auto site-px" style={{ paddingTop: '64px', paddingBottom: '48px', borderBottom: '1px solid #B8C0B8' }}>
        ...
        <p className="font-lato text-accent" style={{ fontSize: '16px', lineHeight: '1.7em', letterSpacing: '0.3px', maxWidth: '680px' }}>
          Encuentra los datos de contacto de los comisionados, el secretariado ejecutivo, los órganos auxiliares y los centros adscritos al Órgano de Administración del Estado de Durango.
        </p>
      ...
      <div className="max-w-content mx-auto site-px" style={{ paddingTop: '48px', paddingBottom: '80px' }}>
        <ContactoSecciones secciones={contactoOrganoAdministracion.secciones} />
      </div>
